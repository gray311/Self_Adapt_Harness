"""Stable, read-only snapshot exposed to generated Cordis plugins.

Generated tools and ``agent/pre-step`` middleware obtain this mapping only
through the trusted, authenticated ``sahBridge`` service.
