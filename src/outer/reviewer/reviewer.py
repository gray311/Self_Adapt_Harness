"""Compatibility shim — this module moved to ``outer.safety.reviewer.reviewer``.
...
if __name__ == "__main__":
    import runpy
    runpy.run_module("outer.safety.reviewer.reviewer", run_name="__main__")
else:
    import sys as _sys
    import outer.safety.reviewer.reviewer as _module
